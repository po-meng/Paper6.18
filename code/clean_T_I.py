...
def clean_all_files(file_map: dict):
    ...
    report_path = CLEAN_DIR / "TorontoIslandA_cleaning_report.csv"
    ...
    annual_report_path = CLEAN_DIR / "TorontoIslandA_annual_hour_count_report.csv"
